...
<div class="row">
    <div class="col-12">
        ...
        <div class="card-body">
            ...
            <form id="userform" action="{{ route("userupdate") }}" method="POST" enctype="multipart/form-data">
                @csrf

                <input type="hidden" id="id" name="id" value="{{ old('id', isset($user) ? $user->id : '') }}">
                ...
                <div class="row">
                      ...
                      <label for="roles">Role</label>
                        ...
                        <select class="form-select" id="roles" name="roles">
                            ...
                            @foreach($roles as $role)
                                ...
                                <option value="{{$role}}" {{ isset($adminuserrole) && $role === $adminuserrole ? 'selected' : '' }}>{{$role}}</option>
                    ...
                    <div class="form-group">
                        <ul class="list-unstyled mb-0">
                            <li class="d-inline-block" style="margin-right: 20px;">
                                <fieldset>
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" value="1" name="status" id="customRadio1" @if($user->status == 1) ? checked : '') @endif>
                            ...
                            <li class="d-inline-block">
                                <fieldset>
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" name="status" value="0" id="customRadio2" @if($user->status == 0) ? checked : '') @endif>
                  ...
                  <div class="col-12 mt-2">
                    ...
                    <button type="button" id="submit" onclick="checkvalidation()" class="btn btn-primary text-white">Update User</button>
...
<script>
    ...
    function checkvalidation() {
        ...
        var isvalidname = isvalidemail = isvalidroles = 0;
        ...
        if (roles == '')
        {
            ...
            new PNotify({title: 'Please select role !', styling: 'fontawesome', delay: '3000', type: 'error'});
            isvalidroles = 0;
        }
        else
        {
        ...
        if (isvalidname == 1 && isvalidemail == 1 && isvalidroles == 1) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response == 1) {
                        new PNotify({title: "User successfully updated.", styling: 'fontawesome', delay: '3000', type: 'success'});
                        setTimeout(function () {
