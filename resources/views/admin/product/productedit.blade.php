...
<div class="row">
    <div class="col-12">
        ...
        <div class="card-body">
            ...
            <form id="orgform" action="{{ route("productupdate") }}" method="POST" enctype="multipart/form-data">
                @csrf

                <input type="hidden" id="id" name="id" value="{{ old('id', isset($product) ? $product->id : '') }}">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12 mb-2" id="thumbnail_div">
                        ...
                        <label for="thumbnail">Product Thumbnail</label>
                            ...
                            <?php if(isset($product->thumbnail) && !empty($product->thumbnail)){ ?>
                                <center>
                                    <img class="rounded-3 img-fluid" style="height:80px; width:80px;" src="{{url('/productthumbnail/'.$product->thumbnail)}}" alt="thumbnail">
                                </center>
                            <?php } ?>

                    </div>

                    <div class="form-group col-md-12 mb-2" id="image_div">
                        ...
                        <div class="col-md-12 mt-2 mb-4">
                            ...
                            <div class="row">
                                ...
                                @foreach ($productimages as $productimage)
                                    ...
                                    <div class="col-1" id="remove{{$productimage->id}}">

                                        <div class="row">
                                            <div class="col-12 text-center">
                                                <img
                                                class="rounded-3 img-fluid border"
                                                style="height:80px; width:80px;" src="{{asset('productimages/'.$productimage->image)}}" alt="image">
                                            </div>

                                            <div class="col-12 text-center">
                                                <a data-id="{{$productimage->id}}" href="javascript:;" class="deleteimage">
                                                    <button style="width:80px;" type="button" class="btn btn-danger btn-sm"><i class="fa-regular fa-trash-can"></i></button>
                                                </a>
                                            </div>
                                        </div>
                    ...
                    <div class="form-group col-md-12 mb-2">
                        <ul class="list-unstyled mb-0">
                            <li class="d-inline-block" style="margin-right: 20px;">
                                <fieldset>
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" value="1" name="status" id="customRadio1" @if($product->status == 1) ? checked : '') @endif>
                            ...
                            <li class="d-inline-block">
                                <fieldset>
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" name="status" value="0" id="customRadio2" @if($product->status == 0) ? checked : '') @endif>
                    ...
                    <div class="col-12 mt-2">
                        ...
                        <button id="submit" onclick="checkvalidation()"  type="button" class="btn btn-primary text-white">Update Product</button>
...
<script>
    ...
    function checkvalidation()
    {
        ...
        if (isvalidcatid == 1 && isvalidname == 1 && isvalidbrand == 1 && isvalidcode == 1 && isvalidqty == 1 && isvalidprice == 1 && isvalideditor == 1)
        {
