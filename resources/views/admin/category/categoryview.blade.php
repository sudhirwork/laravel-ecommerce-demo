    ...
    <div class="col-12 mb-3">
        <div class="card">
            <div class="card-header">
                <h4 class="pt-2">Category Details</h4>
            </div>
            <div class="card-body">

                <ul class="list-group">

                    <li class="list-group-item"><strong>Category Name: </strong><?php echo $category->name; ?></li>
...
<?php if(Auth::user()->can('product-list')) { ?>

  <script type="text/javascript">

      var val = $("#id").val();
      var ur = '{{ route("admin.getCategoryProduct",["id" =>  ":val"]) }}';
    ...
    $(document).ready(function() {
      ...
      $(document).on('click','.deleteRecord',function(){
        ...
        var id = $(this).data("id");
        var ur1 = '{{ route("productdestroy",["id" =>  ":val"]) }}';
        var url1 =ur1.replace(':val', id);
