...
<div class="row">
    <div class="col-12">
        ...
        <div class="card-header">
            <h4 class="pt-2">Edit Category</h4>
        </div>
        <div class="card-body">

            <form id="orgform" class="passenger-validation form form-vertical" action="{{ route("categoryupdate") }}" method="POST" enctype="multipart/form-data">
                @csrf

                <input type="hidden" id="id" name="id" value="{{ old('id', isset($category) ? $category->id : '') }}">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12 mb-2">
                        <ul class="list-unstyled mb-0">
                            <li class="d-inline-block" style="margin-right: 20px;">
                                <fieldset>
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" value="1" name="status" id="customRadio1" @if($category->status == 1) ? checked : '') @endif>
                            ...
                            <li class="d-inline-block">
                                <fieldset>
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" name="status" value="0" id="customRadio2" @if($category->status == 0) ? checked : '') @endif>
                    ...
                    <div class="col-12 mt-2">
                        ...
                        <button id="submit" onclick="checkvalidation()"  type="button" class="btn btn-primary text-white">Update Category</button>
