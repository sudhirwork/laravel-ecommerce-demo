...
<div class="row">
    ...
    <div class="col-2 text-right">
        ...
        @can('role-add')
            <a href="{{route('roleadd')}}" class="btn btn-primary text-white">Add Role</a>
        @endcan
  ...
  <script type="text/javascript">
      ...
      $(document).ready(function() {
          ...
          $(document).on('click','.deleteRecord',function() {
              ...
              Swal.fire({
        title: 'Are you sure?',
                text: "All admin-users for this role are inactive, You won't be able to revert this!",
                type: 'warning',
                      ...
                      $.ajax({
                        ...
                        success: function () {
                          ...
                          Swal.fire({
                            type: "success",
                            title: 'Deleted!',
                            text: 'Your role has been deleted and All admin-users for this role are inactived successfully!',
