...
<div class="row">
    <div class="col-12">
        ...
        <div class="card-header">
            <h4 class="pt-2">Add Role & Permissions</h4>
        </div>
        <div class="card-body">

            <form id="orgform" action="{{ route("rolestore") }}" method="POST" enctype="multipart/form-data">
                @csrf

                <div class="mt-2" id="namediv">
                    <label for="name">Role Name</label>
                    <input type="text" id="name" class="form-control" name="name" placeholder="Role Name">
                </div>
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-2 col-12 border pt-2 pb-2 mb-2" style="border-radius: 10px; margin-right: 52px;">
                                ...
                                <div class="form-check form-switch">
                                    ...
                                    <input
                                        type="checkbox"
                                        role="switch"
                                        name="permission[]" value="{{$permissions->id}}" class="form-check-input permission" id="customSwitch{{$permissions->id}}"
                                    />
                ...
                <div class="col-12 text-center mb-1">
                    ...
                    <button type="button" onclick="checkvalidation()" id="submit" class="btn btn-primary text-white">Add Role & Permissions</button>
        ...
        if (isvalidname == 1 && isvalidpermission == 1)
        {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response == 1) {
                        new PNotify({title: "Role & Permissions successfully Added.", styling: 'fontawesome', delay: '3000', type: 'success'});
                        setTimeout(function () {
                        ...
                        // new PNotify({title: 'Admin-User Not Added !', styling: 'fontawesome', delay: '3000', type: 'error'});
                    }
                },
                error: function (xhr) {
